...
* [💽 A C++ written decoder for WAV files](https://github.com/soundhive/cpp-canonical-wav-decoder)
* [🪙 A Solidity powered executable NFT on the Ethereum blockchain](https://github.com/NFpieT/NFpieT)
* [🖼️ A platform allowing people to code pattern detection algorithms for images in several languages](https://github.com/pattern-finder)
